...
const PLAYER_CONTEXT_KEY = Symbol.for("@webplayer/player");
/**
...
const MEDIA_CONTEXT_KEY = Symbol.for("@webplayer/media");
const mediaContext = createContext(MEDIA_CONTEXT_KEY);
const CONTAINER_CONTEXT_KEY = Symbol.for("@webplayer/container");
const containerContext = createContext(CONTAINER_CONTEXT_KEY);

//#endregion
export { ContextRequestEvent as a, createContext as i, mediaContext as n, safeDefine as o, playerContext as r, containerContext as t };
//# sourceMappingURL=context-0rI_P6jf.js.map