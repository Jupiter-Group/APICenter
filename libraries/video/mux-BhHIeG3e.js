import { n as Hls, t as HlsMedia } from "./hls-CcSAx_3I.js";

//#region ../core/dist/dev/dom/media/castable/utils.js
...
//#endregion
//#region ../core/dist/dev/dom/media/castable/google-cast-provider.js
...
var GoogleCastProvider = class {
	...
	async load() {
		...
		mediaInfo.customData = this.media.castCustomData ?? null;
		const subtitles = [...this.media.querySelectorAll("track")].filter((el) => el.src && (el.kind === "subtitles" || el.kind === "captions"));
		...
		mediaInfo.streamType = this.media.castStreamType === "live" ? chrome.cast.media.StreamType.LIVE : chrome.cast.media.StreamType.BUFFERED;
	...
	pause() {
		if (!this.paused) this.#remote.controller?.playOrPause();
	}
	get paused() {
		return this.#remote.isPaused || this.ended;
	}
	get ended() {
		return this.#remote.playerState === chrome.cast.media.PlayerState.IDLE && currentMedia()?.idleReason === chrome.cast.media.IdleReason.FINISHED;
	}
	get muted() {
		return this.#remote.isMuted;
	}
	set muted(value) {
		if (value !== this.#remote.isMuted) this.#remote.controller?.muteOrUnmute();
	}
	get volume() {
	...
	init() {
		...
		this.#remoteListeners = {
			[cf.RemotePlayerEventType.IS_CONNECTED_CHANGED]: (event) => {
			...
			[cf.RemotePlayerEventType.PLAYER_STATE_CHANGED]: () => {
				...
				const state = this.isCasting ? this.#remote.playerState : void 0;
	...
	async #updateRemoteTextTrack() {
		...
		const matched = (this.#remote.mediaInfo?.tracks ?? []).filter(({ type }) => type === chrome.cast.media.TrackType.TEXT).flatMap(({ language, name, trackId }) => {
...
//#endregion
//#region ../core/dist/dev/dom/media/castable/remote-playback.js
...
var RemotePlayback = class extends EventTarget {
	...
	#assertEnabled() {
		if (this.#provider.media.disableRemotePlayback) throw new InvalidStateError("disableRemotePlayback attribute is present.");
	}
	#setState(next) {
...
//#endregion
//#region ../core/dist/dev/dom/media/castable/index.js
const CastableMediaMixin = (superclass) => {
	class CastableMedia extends superclass {
		...
		set castReceiver(val) {
			...
			if (val) this.#castOptions.receiverApplicationId = val;
		}
		get castSrc() {
...
//#endregion
//#region ../../node_modules/.pnpm/mux-embed@5.17.10/node_modules/mux-embed/dist/mux.mjs
...
var Y = {
	...
	var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3, t, i, a, n, o, s = r ? [console, r] : [console], u = (t = console.trace).bind.apply(t, V(s)), f = (i = console.info).bind.apply(i, V(s)), h = (a = console.debug).bind.apply(a, V(s)), E = (n = console.warn).bind.apply(n, V(s)), y = (o = console.error).bind.apply(o, V(s)), c = e;
	return {
		trace: function() {
...
var Le = G(Q());
function ce() {
	return (Le.default.doNotTrack || Le.default.navigator && Le.default.navigator.doNotTrack) === "1";
}
function b(r) {
...
var It = function(r, e) {
	...
	var y = function(_) {
		...
		var d = _.type, g = _.chunk, T = _.request, k = g || {}, D = k.mediaInfo, L = k.start, A = (D || {}).type, R = It(T, t), Z = R.requestStart, we = R.requestResponseStart, Te = R.requestResponseEnd, W = R.requestBytesLoaded, oe = R.requestResponseHeaders, je = R.requestMediaDuration, We = R.requestHostname, Ge = R.requestUrl, ke = R.requestId, z = _a(A, t), Yr = z.currentLevel, Xr = z.renditionWidth, $r = z.renditionHeight, Zr = z.renditionBitrate;
		o("requestcompleted", {
			request_event_type: d,
			request_start: Z,
			request_response_start: we,
	...
	var p = {
		...
		if (p.video && typeof p.video.bitrate == "number") {
			...
			if (p.audio && typeof p.audio.bitrate == "number" && (_ += p.audio.bitrate), _ !== p.totalBitrate) return p.totalBitrate = _, {
				...
				video_source_codec: fa(p.video.codec)
			};
		}
	}, x = function(_, d, g) {
		var T = _.mediaType;
		if (T === "audio" || T === "video") {
			...
			p[T] = fe(ue({}, k), { codec: t.getCurrentTrackFor(T).codec });
			var C = w();
...
var Wt = 300 * 1e3, Gt = function r(e) {
	"use strict";
...
var Yt = function(e, t) {
	...
	function r(e) {
		...
		e.on("adbreakstart", function() {
			...
			n = Object.assign({ ad_request_id: "generatedAdRequestId" + t._currentAdRequestNumber++ }, n), Yt(t._adRequests, n), O(e.data, "view_ad_request_count"), t.inPrerollPosition() && (e.data.view_preroll_requested = !0, t._adHasPlayed || O(e.data, "view_preroll_request_count"));
...
var Zt = "muxData", Aa = function(r) {
	...
	var e = er(), t = P.now();
	return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = ee(), e.sst = t), e.sex = t + 1500 * 1e3, tr(e), {
		session_id: e.sid,
		session_start: e.sst,
...
$.prototype._clearBeaconQueue = function() {
	...
	r > 0 && Object.assign(e[e.length - 1], me({ mux_view_message: "event queue truncated" }));
	...
	return N(r, [
		{
			...
			value: function(t, i) {
				if (!(!t || !(i != null && i.view_id))) {
					...
					var o, s = ((o = n.mux_sample_number) !== null && o !== void 0 ? o : 0) >= this.sampleRate, f = me(this._deduplicateBeaconData(t, n));
...
var xi = [
	...
	function t(i, a, n) {
		...
		}, n), n.data = n.data || {}, n.data.property_key && (n.data.env_key = n.data.property_key, delete n.data.property_key), q.level = n.debug ? Y.DEBUG : Y.WARN, o.getPlayheadTime = n.getPlayheadTime, o.getStateData = n.getStateData || function() {
			return {};
			...
			value: function(a) {
				if (this.data.view_id) {
					...
					if (n.video_source_is_live === void 0 && (n.player_source_duration === Infinity || n.video_source_duration === Infinity ? n.video_source_is_live = !0 : (n.player_source_duration > 0 || n.video_source_duration > 0) && (n.video_source_is_live = !1)), n.video_source_is_live || [
						...
						var s = H(re(n.video_source_url), 2), u = s[0];
...
function ot(r, e, t) {
	var i = H(se(e), 3), a = i[0], n = i[1], o = i[2], s = r.log, u = r.utils.getComputedStyle, f = r.utils.secondsToMs, h = { automaticErrorTracking: !0 };
	if (a) {
	...
	a.mux.destroy = function() {
		...
		var p = H(se(c), 3), w = p[0], x = p[1], v = p[2];
		if (w) {
...
Ve.prototype.processLine = function(r) {
	var t = Li(r, r.indexOf(":")), i = t[0], a = t.length === 2 ? ct(t[1]) : void 0;
...
//#endregion
//#region ../core/dist/dev/dom/media/mux/mux-data.js
...
//#endregion
//#region ../core/dist/dev/dom/media/mux/index.js
var MuxVideoMedia = class extends MuxDataMediaMixin(CastableMediaMixin(HlsMedia)) {
	static PLAYER_SOFTWARE_NAME = "mux-video";
};
var MuxAudioMedia = class extends MuxDataMediaMixin(CastableMediaMixin(HlsMedia)) {
	static PLAYER_SOFTWARE_NAME = "mux-audio";
};

//#endregion
export { MuxVideoMedia as n, MuxAudioMedia as t };
//# sourceMappingURL=mux-BhHIeG3e.js.map