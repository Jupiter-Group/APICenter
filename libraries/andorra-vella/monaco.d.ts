...
type andorra_contribution$3_CSSDataConfiguration = CSSDataConfiguration;
type andorra_contribution$3_CSSDataV1 = CSSDataV1;
type andorra_contribution$3_CSSFormatConfiguration = CSSFormatConfiguration;
type andorra_contribution$3_EntryStatus = EntryStatus;
type andorra_contribution$3_IAtDirectiveData = IAtDirectiveData;
type andorra_contribution$3_IPropertyData = IPropertyData;
type andorra_contribution$3_IPseudoClassData = IPseudoClassData;
type andorra_contribution$3_IPseudoElementData = IPseudoElementData;
declare const andorra_contribution$3_cssDefaults: typeof cssDefaults;
declare const andorra_contribution$3_lessDefaults: typeof lessDefaults;
declare const andorra_contribution$3_scssDefaults: typeof scssDefaults;
declare namespace andorra_contribution$3 {
  export { andorra_contribution$3_cssDefaults as cssDefaults, andorra_contribution$3_lessDefaults as lessDefaults, andorra_contribution$3_scssDefaults as scssDefaults };
  export type { andorra_contribution$3_CSSDataConfiguration as CSSDataConfiguration, andorra_contribution$3_CSSDataV1 as CSSDataV1, andorra_contribution$3_CSSFormatConfiguration as CSSFormatConfiguration, DiagnosticsOptions$2 as DiagnosticsOptions, andorra_contribution$3_EntryStatus as EntryStatus, andorra_contribution$3_IAtDirectiveData as IAtDirectiveData, andorra_contribution$3_IPropertyData as IPropertyData, andorra_contribution$3_IPseudoClassData as IPseudoClassData, andorra_contribution$3_IPseudoElementData as IPseudoElementData, IReference$1 as IReference, IValueData$1 as IValueData, LanguageServiceDefaults$3 as LanguageServiceDefaults, MarkupContent$1 as MarkupContent, MarkupKind$1 as MarkupKind, ModeConfiguration$3 as ModeConfiguration, Options$1 as Options };
}
...
type andorra_contribution$2_CompletionConfiguration = CompletionConfiguration;
type andorra_contribution$2_HTMLDataConfiguration = HTMLDataConfiguration;
type andorra_contribution$2_HTMLDataV1 = HTMLDataV1;
type andorra_contribution$2_HTMLFormatConfiguration = HTMLFormatConfiguration;
type andorra_contribution$2_IAttributeData = IAttributeData;
type andorra_contribution$2_IReference = IReference;
type andorra_contribution$2_ITagData = ITagData;
type andorra_contribution$2_IValueData = IValueData;
type andorra_contribution$2_IValueSet = IValueSet;
type andorra_contribution$2_LanguageServiceRegistration = LanguageServiceRegistration;
type andorra_contribution$2_MarkupContent = MarkupContent;
type andorra_contribution$2_MarkupKind = MarkupKind;
type andorra_contribution$2_Options = Options;
declare const andorra_contribution$2_handlebarDefaults: typeof handlebarDefaults;
declare const andorra_contribution$2_handlebarLanguageService: typeof handlebarLanguageService;
declare const andorra_contribution$2_htmlDefaults: typeof htmlDefaults;
declare const andorra_contribution$2_htmlLanguageService: typeof htmlLanguageService;
declare const andorra_contribution$2_razorDefaults: typeof razorDefaults;
declare const andorra_contribution$2_razorLanguageService: typeof razorLanguageService;
declare const andorra_contribution$2_registerHTMLLanguageService: typeof registerHTMLLanguageService;
declare namespace andorra_contribution$2 {
  export { andorra_contribution$2_handlebarDefaults as handlebarDefaults, andorra_contribution$2_handlebarLanguageService as handlebarLanguageService, andorra_contribution$2_htmlDefaults as htmlDefaults, andorra_contribution$2_htmlLanguageService as htmlLanguageService, andorra_contribution$2_razorDefaults as razorDefaults, andorra_contribution$2_razorLanguageService as razorLanguageService, andorra_contribution$2_registerHTMLLanguageService as registerHTMLLanguageService };
  export type { andorra_contribution$2_CompletionConfiguration as CompletionConfiguration, andorra_contribution$2_HTMLDataConfiguration as HTMLDataConfiguration, andorra_contribution$2_HTMLDataV1 as HTMLDataV1, andorra_contribution$2_HTMLFormatConfiguration as HTMLFormatConfiguration, andorra_contribution$2_IAttributeData as IAttributeData, andorra_contribution$2_IReference as IReference, andorra_contribution$2_ITagData as ITagData, andorra_contribution$2_IValueData as IValueData, andorra_contribution$2_IValueSet as IValueSet, LanguageServiceDefaults$2 as LanguageServiceDefaults, andorra_contribution$2_LanguageServiceRegistration as LanguageServiceRegistration, andorra_contribution$2_MarkupContent as MarkupContent, andorra_contribution$2_MarkupKind as MarkupKind, ModeConfiguration$2 as ModeConfiguration, andorra_contribution$2_Options as Options };
}
...
type andorra_contribution$1_ASTNode = ASTNode;
type andorra_contribution$1_ArrayASTNode = ArrayASTNode;
type andorra_contribution$1_BaseASTNode = BaseASTNode;
type andorra_contribution$1_BooleanASTNode = BooleanASTNode;
type andorra_contribution$1_IJSONWorker = IJSONWorker;
type andorra_contribution$1_JSONDocument = JSONDocument;
type andorra_contribution$1_JSONSchema = JSONSchema;
type andorra_contribution$1_JSONSchemaMap = JSONSchemaMap;
type andorra_contribution$1_JSONSchemaRef = JSONSchemaRef;
type andorra_contribution$1_MatchingSchema = MatchingSchema;
type andorra_contribution$1_NullASTNode = NullASTNode;
type andorra_contribution$1_NumberASTNode = NumberASTNode;
type andorra_contribution$1_ObjectASTNode = ObjectASTNode;
type andorra_contribution$1_PropertyASTNode = PropertyASTNode;
type andorra_contribution$1_SeverityLevel = SeverityLevel;
type andorra_contribution$1_StringASTNode = StringASTNode;
declare const andorra_contribution$1_getWorker: typeof getWorker;
declare const andorra_contribution$1_jsonDefaults: typeof jsonDefaults;
declare namespace andorra_contribution$1 {
  export { andorra_contribution$1_getWorker as getWorker, andorra_contribution$1_jsonDefaults as jsonDefaults };
  export type { andorra_contribution$1_ASTNode as ASTNode, andorra_contribution$1_ArrayASTNode as ArrayASTNode, andorra_contribution$1_BaseASTNode as BaseASTNode, andorra_contribution$1_BooleanASTNode as BooleanASTNode, DiagnosticsOptions$1 as DiagnosticsOptions, andorra_contribution$1_IJSONWorker as IJSONWorker, andorra_contribution$1_JSONDocument as JSONDocument, andorra_contribution$1_JSONSchema as JSONSchema, andorra_contribution$1_JSONSchemaMap as JSONSchemaMap, andorra_contribution$1_JSONSchemaRef as JSONSchemaRef, LanguageServiceDefaults$1 as LanguageServiceDefaults, andorra_contribution$1_MatchingSchema as MatchingSchema, ModeConfiguration$1 as ModeConfiguration, andorra_contribution$1_NullASTNode as NullASTNode, andorra_contribution$1_NumberASTNode as NumberASTNode, andorra_contribution$1_ObjectASTNode as ObjectASTNode, andorra_contribution$1_PropertyASTNode as PropertyASTNode, andorra_contribution$1_SeverityLevel as SeverityLevel, andorra_contribution$1_StringASTNode as StringASTNode };
}
...
type andorra_contribution_CompilerOptions = CompilerOptions;
type andorra_contribution_Diagnostic = Diagnostic;
type andorra_contribution_DiagnosticRelatedInformation = DiagnosticRelatedInformation;
type andorra_contribution_DiagnosticsOptions = DiagnosticsOptions;
type andorra_contribution_EmitOutput = EmitOutput;
type andorra_contribution_IExtraLibs = IExtraLibs;
type andorra_contribution_JsxEmit = JsxEmit;
declare const andorra_contribution_JsxEmit: typeof JsxEmit;
type andorra_contribution_LanguageServiceDefaults = LanguageServiceDefaults;
type andorra_contribution_ModeConfiguration = ModeConfiguration;
type andorra_contribution_ModuleKind = ModuleKind;
declare const andorra_contribution_ModuleKind: typeof ModuleKind;
type andorra_contribution_ModuleResolutionKind = ModuleResolutionKind;
declare const andorra_contribution_ModuleResolutionKind: typeof ModuleResolutionKind;
type andorra_contribution_NewLineKind = NewLineKind;
declare const andorra_contribution_NewLineKind: typeof NewLineKind;
type andorra_contribution_ScriptTarget = ScriptTarget;
declare const andorra_contribution_ScriptTarget: typeof ScriptTarget;
type andorra_contribution_TypeScriptWorker = TypeScriptWorker;
type andorra_contribution_WorkerOptions = WorkerOptions;
declare const andorra_contribution_getJavaScriptWorker: typeof getJavaScriptWorker;
declare const andorra_contribution_getTypeScriptWorker: typeof getTypeScriptWorker;
declare const andorra_contribution_javascriptDefaults: typeof javascriptDefaults;
declare const andorra_contribution_typescriptDefaults: typeof typescriptDefaults;
declare const andorra_contribution_typescriptVersion: typeof typescriptVersion;
declare namespace andorra_contribution {
  export { andorra_contribution_JsxEmit as JsxEmit, andorra_contribution_ModuleKind as ModuleKind, andorra_contribution_ModuleResolutionKind as ModuleResolutionKind, andorra_contribution_NewLineKind as NewLineKind, andorra_contribution_ScriptTarget as ScriptTarget, andorra_contribution_getJavaScriptWorker as getJavaScriptWorker, andorra_contribution_getTypeScriptWorker as getTypeScriptWorker, andorra_contribution_javascriptDefaults as javascriptDefaults, andorra_contribution_typescriptDefaults as typescriptDefaults, andorra_contribution_typescriptVersion as typescriptVersion };
  export type { andorra_contribution_CompilerOptions as CompilerOptions, andorra_contribution_Diagnostic as Diagnostic, andorra_contribution_DiagnosticRelatedInformation as DiagnosticRelatedInformation, andorra_contribution_DiagnosticsOptions as DiagnosticsOptions, andorra_contribution_EmitOutput as EmitOutput, andorra_contribution_IExtraLibs as IExtraLibs, andorra_contribution_LanguageServiceDefaults as LanguageServiceDefaults, andorra_contribution_ModeConfiguration as ModeConfiguration, andorra_contribution_TypeScriptWorker as TypeScriptWorker, andorra_contribution_WorkerOptions as WorkerOptions };
}
...
declare global { export import andorra = editor_main; }
