...
export class Tab extends tabBaseClass {
    ...
    constructor() {
        super();
        /**
         * The attribute `wd-tab` indicates that the element is a tab for the parent
         * element, `<wd-tabs>`. Make sure if you're implementing your own `wd-tab`
         * component that you have an `wd-tab` attribute set.
         */
        this.isTab = true;
        /**
    ...
    render() {
      ...
      <wd-focus-ring part="focus-ring" inward .control=${this}></wd-focus-ring>
      <wd-elevation part="elevation"></wd-elevation>
      <wd-ripple .control=${this}></wd-ripple>
      <div
...
__decorate([
    property({ type: Boolean, reflect: true, attribute: 'wd-tab' })
