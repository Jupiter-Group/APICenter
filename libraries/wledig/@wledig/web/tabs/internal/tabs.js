...
export class Tabs extends LitElement {
    ...
    set activeTabIndex(index) {
        ...
        if (!this.slotElement) {
            ...
            // ```ts
            // html`
            //   <wd-tabs .activeTabIndex=${1}>
            //     <wd-tab>First</wd-tab>
            //     <wd-tab>Second</wd-tab>
            //   </wd-tabs>
            // `;
            // ```
            //
    ...
    render() {
      ...
      <wd-divider part="divider"></wd-divider>
    `;
    }
    ...
    activateTab(activeTab) {
        ...
        if (previousTab) {
            ...
            // were selected, such as when wd-tabs auto-selects the first tab.
...
__decorate([
    queryAssignedElements({ flatten: true, selector: '[wd-tab]' })
...
function isTab(element) {
    return element instanceof HTMLElement && element.hasAttribute('wd-tab');
}
