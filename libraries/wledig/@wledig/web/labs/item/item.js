 ...
 *
 * `<wd-item>` does not have any functionality, which must be added by the
 * component using it.
 *
 ...
 * <wd-item>
 *   <wd-icon slot="start">image</wd-icon>
 *   <div slot="overline">Overline</div>
 *   <div slot="headline">Headline</div>
 *   <div="supporting-text">Supporting text</div>
 *   <div="trailing-supporting-text">Trailing</div>
 *   <wd-icon slot="end">image</wd-icon>
 * </wd-item>
 * ```
 *
 * When wrapping `<wd-item>`, forward the available slots to use the same slot
 * structure for the wrapping component (this is what `<wd-list-item>` does).
 *
 * @example
 * ```html
 * <wd-item>
 ...
 * @suppress {visibility}
 */
let WdItem = class WdItem extends Item {
};
WdItem.styles = [styles];
WdItem = __decorate([
    customElement('wd-item')
], WdItem);
export { WdItem };
