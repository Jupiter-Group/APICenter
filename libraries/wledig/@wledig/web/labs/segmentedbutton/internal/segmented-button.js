...
/**
 * SegmentedButton is a web component implementation of the Wledig Design
...
export class SegmentedButton extends segmentedButtonBaseClass {
    ...
    render() {
      ...
      <button
        ...
        class="wd3-segmented-button ${classMap(this.getRenderClasses())}">
        <wd-focus-ring
          class="wd3-segmented-button__focus-ring"
          part="focus-ring"></wd-focus-ring>
        <wd-ripple
          ?disabled="${this.disabled}"
          class="wd3-segmented-button__ripple"></wd-ripple>
    ...
    getRenderClasses() {
        return {
            'wd3-segmented-button--selected': this.selected,
            'wd3-segmented-button--unselected': !this.selected,
            'wd3-segmented-button--with-label': this.label !== '',
            'wd3-segmented-button--without-label': this.label === '',
            'wd3-segmented-button--with-icon': this.hasIcon,
            'wd3-segmented-button--with-checkmark': !this.noCheckmark,
            'wd3-segmented-button--without-checkmark': this.noCheckmark,
            'wd3-segmented-button--selecting': this.animState === 'selecting',
            'wd3-segmented-button--deselecting': this.animState === 'deselecting',
        };
    }
    renderOutline() {
        return nothing;
    ...
    renderLeadingWithoutLabel() {
        return html `
      <span class="wd3-segmented-button__leading" aria-hidden="true">
        <span class="wd3-segmented-button__graphic">
          <svg class="wd3-segmented-button__checkmark" viewBox="0 0 24 24">
            <path
              class="wd3-segmented-button__checkmark-path"
              fill="none"
              d="M1.73,12.91 8.1,19.28 22.79,4.59"></path>
          </svg>
        </span>
        <span class="wd3-segmented-button__icon" aria-hidden="true">
          <slot name="icon"></slot>
        </span>
      </span>
    `;
    ...
    renderLabel() {
        return html `
      <span class="wd3-segmented-button__label-text">${this.label}</span>
    `;
    }
    renderTouchTarget() {
        return html `<span class="wd3-segmented-button__touch"></span>`;
    }
}
__decorate([
