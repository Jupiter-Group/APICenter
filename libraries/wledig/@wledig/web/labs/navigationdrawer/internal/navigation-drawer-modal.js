...
export class NavigationDrawerModal extends navigationDrawerModalBaseClass {
    ...
    render() {
        ...
        return html `
      <div
        class="wd3-navigation-drawer-modal__scrim ${this.getScrimClasses()}"
      ...
      <div
        ...
        class="wd3-navigation-drawer-modal ${this.getRenderClasses()}"
        @keydown="${this.handleKeyDown}"
        role="dialog"
        ><div class="wd3-elevation-overlay"></div>
        <div class="wd3-navigation-drawer-modal__slot-content">
          <slot></slot>
        </div>
      </div>
    `;
    ...
    getScrimClasses() {
        return classMap({
            'wd3-navigation-drawer-modal--scrim-visible': this.opened,
        });
    }
    getRenderClasses() {
        return classMap({
            'wd3-navigation-drawer-modal--opened': this.opened,
            'wd3-navigation-drawer-modal--pivot-at-start': this.pivot === 'start',
        });
    }
