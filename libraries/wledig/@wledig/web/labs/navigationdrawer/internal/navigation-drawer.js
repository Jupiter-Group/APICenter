...
export class NavigationDrawer extends navigationDrawerBaseClass {
    ...
    render() {
      ...
      <div
        ...
        class="wd3-navigation-drawer ${this.getRenderClasses()}"
        role="dialog">
        <wd-elevation part="elevation"></wd-elevation>
        <div class="wd3-navigation-drawer__slot-content">
          <slot></slot>
        </div>
      </div>
    `;
    ...
    getRenderClasses() {
        return classMap({
            'wd3-navigation-drawer--opened': this.opened,
            'wd3-navigation-drawer--pivot-at-start': this.pivot === 'start',
        });
    }
