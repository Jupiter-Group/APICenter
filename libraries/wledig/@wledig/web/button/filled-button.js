 ...
 * @suppress {visibility}
 */
let WdFilledButton = class WdFilledButton extends FilledButton {
};
WdFilledButton.styles = [
    sharedStyles,
    sharedElevationStyles,
    filledStyles,
];
WdFilledButton = __decorate([
    customElement('wd-filled-button')
], WdFilledButton);
export { WdFilledButton };
