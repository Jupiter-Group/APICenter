 ...
 * @suppress {visibility}
 */
let WdElevatedButton = class WdElevatedButton extends ElevatedButton {
};
WdElevatedButton.styles = [
    sharedStyles,
    sharedElevationStyles,
    elevatedStyles,
];
WdElevatedButton = __decorate([
    customElement('wd-elevated-button')
], WdElevatedButton);
export { WdElevatedButton };
