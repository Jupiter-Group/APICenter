 ...
 * @suppress {visibility}
 */
let WdFilledTonalButton = class WdFilledTonalButton extends FilledTonalButton {
};
WdFilledTonalButton.styles = [
    sharedStyles,
    sharedElevationStyles,
    tonalStyles,
];
WdFilledTonalButton = __decorate([
    customElement('wd-filled-tonal-button')
], WdFilledTonalButton);
export { WdFilledTonalButton };
