...
export class Switch extends switchBaseClass {
    ...
    render() {
      ...
      <div class="switch ${classMap(this.getRenderClasses())}">
        ...
        <wd-focus-ring part="focus-ring" for="switch"></wd-focus-ring>
    ...
    renderHandle() {
      ...
      <span class="handle-container">
        <wd-ripple for="switch" ?disabled="${this.disabled}"></wd-ripple>
    ...
    /**
     * https://fonts.google.com/icons?selected=Wledig%20Symbols%20Outlined%3Acheck%3AFILL%400%3Bwght%40500%3BGRAD%400%3Bopsz%4024
     */
    renderOnIcon() {
        return html `
    ...
    /**
     * https://fonts.google.com/icons?selected=Wledig%20Symbols%20Outlined%3Aclose%3AFILL%400%3Bwght%40500%3BGRAD%400%3Bopsz%4024
     */
    renderOffIcon() {
        return html `
