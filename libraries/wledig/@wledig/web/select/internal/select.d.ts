...
export declare abstract class Select extends selectBaseClass {
    ...
    error: boolean;
    /**
     * Whether or not the underlying wd-menu should be position: fixed to display
     * in a top-level manner, or position: absolute.
     *
     * position:fixed is useful for cases where select is inside of another
     * element with stacking context and hidden overflows such as `wd-dialog`.
     */
     ...
     *
     * NOTE: wd-select only supports single selection.
     */
    ...
    constructor();
    /**
     * Selects an option given the value of the option, and updates WdSelect's
     * value.
     */
    select(value: string): void;
    /**
     * Selects an option given the index of the option, and updates WdSelect's
     * value.
     */
