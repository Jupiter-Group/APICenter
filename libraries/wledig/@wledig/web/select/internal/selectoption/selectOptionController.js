...
/**
 * Creates an event fired by a SelectOption to request selection from wd-select.
 ...
 * wd-select. Typically fired after `selected` changes from `true` to `false`.
 */
...
/**
 * A controller that provides most functionality and wd-select compatibility for
...
export class SelectOptionController {
    ...
    hostUpdated() {
        ...
        if (this.lastSelected !== this.host.selected && !this.firstUpdate) {
            ...
            // handled by wd-select because it needs to coordinate the
