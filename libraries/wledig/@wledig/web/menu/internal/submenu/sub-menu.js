...
export class SubMenu extends LitElement {
    ...
    async show() {
        ...
        // submenu's `<wd-menu slot="submenu" positioning="document">` would be
        // wrong even if we change `wd-sub-menu` from `position: relative` to
        ...
        // user hovers a parent menu's item which is not an wd-sub-menu item.
        ...
        // around the menu and then mouses over an wd-sub-menu.
        this.dispatchEvent(createDeactivateItemsEvent());
...
__decorate([
    property({ type: Boolean, reflect: true, attribute: 'wd-sub-menu' })
