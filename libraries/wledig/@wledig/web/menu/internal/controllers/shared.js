...
export function isElementInSubtree(target, container) {
    ...
    const focusEv = new Event('wd-contains', { bubbles: true, composed: true });
    let composedPath = [];
    const listener = (ev) => {
        composedPath = ev.composedPath();
    };
    container.addEventListener('wd-contains', listener);
    target.dispatchEvent(focusEv);
    container.removeEventListener('wd-contains', listener);
