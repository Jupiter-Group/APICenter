...
/**
 * The interface needed for a Menu to work with other wd-menu elements.
 */
...
/**
 * The interface needed for a Menu to work with other wd-menu elements. Useful
 * for keeping your types safe when wrapping `wd-menu`.
 */
 ...
 * `wd-menu-item` are, Space, Enter or Escape.
 */
...
/**
 * The default menu closing reasons for the wledig wd-menu package.
 */
...
/**
 * Creates a default close menu event used by wd-menu.
 */
...
/**
 * The type of the default close menu event used by wd-menu.
 */
