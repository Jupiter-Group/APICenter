...
export class Menu extends LitElement {
    ...
    constructor() {
         ...
         * when placed inside of them. e.g. using a menu inside of an `wd-dialog`.
         *
         ...
         * - You are reusing a single `wd-menu` element that dynamically renders
         *   content.
         *
         ...
         * `tabindex` to `0` and change wd-menu's display to something other than
        ...
        this.listController = new ListController({
            isItem: (maybeItem) => {
                return maybeItem.hasAttribute('wd-menu-item');
            },
            ...
            isNavigableKey: (key) => {
                ...
                // we want wd-submenu to handle the submenu's left/right arrow exit
        ...
        this.handleFocusout = async (event) => {
            ...
            if (event.relatedTarget) {
                ...
                // wd-menu-item, and wd-list or if the anchor was click focused, but check
     ...
     * have both the `wd-menu-item` and `wd-list-item` attributes.
     */
    get items() {
     ...
     */
    renderElevation() {
        return html `<wd-elevation part="elevation"></wd-elevation>`;
    }
    getSurfaceClasses() {
        return {
            open: this.open,
    ...
    async animateOpen() {
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            // animation.
            child.classList.toggle('wd-menu-hidden', true);
            animation.addEventListener('finish', () => {
                child.classList.toggle('wd-menu-hidden', false);
            });
    ...
    handleDeactivateTypeahead(event) {
        ...
        // nested above it e.g. wd-sub-menu
        event.stopPropagation();
