...
```bash
# npm
npm install @aurorasoft/focusgroup-polyfill

# yarn
yarn add @aurorasoft/focusgroup-polyfill
```

```js
import { polyfill } from "@aurorasoft/focusgroup-polyfill";
...
```js
import { polyfill } from "@aurorasoft/focusgroup-polyfill/shadowless";
// Polyfill the entire document
polyfill();
...
```js
import { polyfillBodyAndObserve } from "@aurorasoft/focusgroup-polyfill";
...
```js
import { FocusGroup } from "@aurorasoft/focusgroup-polyfill";
