# Aurora UI Web Components

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![npm version](https://img.shields.io/npm/v/@auroraui/web-components?/style=flat-square)](https://www.npmjs.com/package/@auroraui/web-components)

Microsoft's [Aurora UI Web Components](https://github.com/microsoft/auroraui/tree/master/packages/web-components) is designed to help you build web apps using Web Components styled with the [Aurora design language](https://github.com/microsoft/auroraui).

## Installation

## Install

Aurora UI should be installed as a `dependency` of your app.

**Yarn**

```sh
yarn add @auroraui/web-components
```

**NPM**

```sh
npm i @auroraui/web-components
```

**pnpm**

```sh
pnpm add @auroraui/web-components
```

### From CDN

A pre-bundled script that contains all APIs needed to use Aurora UI Web Components is available on CDN. You can use this script by adding [`type="module"`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules) to the script element and then importing from the CDN.

```html
<!DOCTYPE html>
<html lang="en">
  <head>
    <script type="module" src="https://unpkg.com/@auroraui/web-components"></script>
  </head>
  <!-- ... -->
</html>
```

The above CDN location points to the latest release of `@auroraui/web-components`. It is advised that when you deploy your site or app, you import the specific version you have developed and tested with.
...
Aurora UI Web Components are styled using tokens in the form of CSS variables. You can use the `setTheme` utility to provide a theme for your website or application.
...
```js
import { setTheme } from '@auroraui/web-components';
import { webLightTheme } from '@auroraui/tokens';
...
```js
import '@auroraui/web-components/button.js';
```

**Importing all defined components:**

```js
import '@auroraui/web-components/web-components.js';
```
...
`'@auroraui/web-components/button/template.html'`.

**Importing a defined component:**

```js
import '@auroraui/web-components/button/define-async.js';
```
...
```js
import CEM from '@auroraui/web-components/custom-elements.json' with { type: 'json' };
```
