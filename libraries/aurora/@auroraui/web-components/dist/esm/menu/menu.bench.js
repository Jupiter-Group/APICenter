...
import './define.js';
const itemRenderer = () => {
    const menu = document.createElement('aurora-menu');
    const menuButton = document.createElement('aurora-menu-button');
    const menuList = document.createElement('aurora-menu-list');
    const menuItem = document.createElement('aurora-menu-item');
    const menuItem2 = document.createElement('aurora-menu-item');
    const menuItem3 = document.createElement('aurora-menu-item');
...
//# sourceMappingURL=menu.bench.js.map