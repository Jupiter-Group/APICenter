import { type PartialFASTElementDefinition } from '@aurorasoft/fast-element/declarative.js';
/**
 * The async definition configuration for the `<aurora-compound-button>` element.
 *
 * @public
 * @remarks
