...
import './define.js';
const itemRenderer = () => {
    const accordion = document.createElement('aurora-accordion');
    const accordionItem = document.createElement('aurora-accordion-item');
    const accordionItem2 = document.createElement('aurora-accordion-item');
    const accordionItem3 = document.createElement('aurora-accordion-item');
