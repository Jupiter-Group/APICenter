import { css } from '@aurorasoft/fast-element';
import { badInputState, customErrorState, disabledState, focusVisibleState, patternMismatchState, rangeOverflowState, rangeUnderflowState, requiredState, stepMismatchState, tooLongState, tooShortState, typeMismatchState, validState, valueMissingState, } from '../styles/states/index.js';
import { borderRadiusMedium, colorNeutralForeground1, colorNeutralForeground3, colorPaletteRedForeground1, colorStrokeFocus2, fontFamilyBase, fontSizeBase200, fontSizeBase300, fontSizeBase400, fontWeightRegular, fontWeightSemibold, lineHeightBase200, lineHeightBase300, lineHeightBase400, spacingHorizontalM, spacingHorizontalXS, spacingVerticalM, spacingVerticalS, spacingVerticalXXS, strokeWidthThick, } from '../theme/design-tokens.js';
